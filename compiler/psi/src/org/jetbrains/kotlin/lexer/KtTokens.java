...
public interface KtTokens {
    ...
    KtModifierKeywordToken ENF_KEYWORD       = KtModifierKeywordToken.softKeywordModifier("enf", ENF_KEYWORD_Id);
    ...
    TokenSet RESERVED_VALUE_PARAMETER_MODIFIER_KEYWORDS = TokenSet.create(OUT_KEYWORD, VARARG_KEYWORD, ENF_KEYWORD);
